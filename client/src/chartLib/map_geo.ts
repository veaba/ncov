...
export const geo: any = {
    ...
    "比利时": [4.342511, 50.851975],
    "罗马尼亚": [26.09219, 44.436037],
    "格鲁吉亚": [44.83234, 41.712311],
    "爱沙尼亚": [24.752065, 59.441325],
    "阿富汗": [69.208133, 34.565176],
    "荷兰": [4.894574, 52.374505],
    "北马其顿": [21.421686, 42.004319],
    "阿尔及利亚": [3.049362, 36.761518],
    "丹麦": [12.438406, 55.67431],
    "克罗地亚": [15.967546, 45.816012],
    "希腊": [23.729501, 37.984104],
    "奥地利": [16.37037, 48.214517],
    "黎巴嫩": [35.503502, 33.895949],
    "伊拉克": [44.358585, 33.322544],
    "阿曼": [58.410737, 23.594832],
    "瑞士": [145.803238, -41.192415],
    "挪威": [10.75167, 59.915741],
    "以色列": [35.223994, 31.789095],
    "西班牙": [-3.698616, 40.42095],
    "巴林": [50.585871, 26.23612],
    "科威特": [47.980026, 29.37729],
    "伊朗": [51.388399, 35.69037],
};

const cityCenterJson = {
...
function a(t: string) {
    const e: any[] = t.split("|");
    e[0] = e[0].split(",");
    return {lng: parseFloat(e[0][0]), lat: parseFloat(e[0][1])};
}

/**
 * @desc 返回城市坐标
 * */
export const getCenterByCityName = (t: string) => {
    t = t.replace("市", "");
    for (let e = 0; e < cityCenterJson.municipalities.length; e++) if (cityCenterJson.municipalities[e].n === t) return a(cityCenterJson.municipalities[e].g);
    for (let e = 0; e < cityCenterJson.other.length; e++) if (cityCenterJson.other[e].n === t) return a(cityCenterJson.other[e].g);
    const n = cityCenterJson.provinces;
    for (let e = 0; e < n.length; e++) {
        if (n[e].n === t) return a(n[e].g);
        for (let i = n[e].cities, o = 0; o < i.length; o++) if (i[o].n === t) return a(i[o].g);
    }
    return null;
};
